...
export default function ServiceCard(props) {
    return (
        <div class="p-6 max-w-sm shadow-2xl bg-white rounded-lg border border-gray-200  dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <h5 class="mb-1 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{props.title}</h5>
            </a>
